			...
			<div class="space-y-3">
                ...
                <nav>
                    <ul class="text-sm space-y-1">
                        <li><a href="#" class="hover:text-orange-500 transition-colors duration-300 text-white">productos</a></li>
                        <li><a href="#" class="hover:text-orange-500 transition-colors duration-300 text-white">Servicios</a></li>
			...
			<div class="space-y-3 mr-4">
				...
				<div class="flex justify-start space-x-3">
					<a rel="noopener noreferrer" href="#" title="Facebook" class="flex items-center p-1">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-5 h-5 fill-white">
					...
					<a rel="noopener noreferrer" href="#" title="Instagram" class="flex items-center p-1">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-5 h-5 fill-white">
